...
echo "----------------------"
test_endpoint "Actor" "$BASE_URL/api/activitypub/actor" "Person" "application/activity+json"
echo ""

echo "3. Collection Endpoint Tests"
echo "---------------------------"
test_endpoint "Outbox" "$BASE_URL/api/activitypub/outbox" "OrderedCollection" "application/activity+json"
test_endpoint "Inbox" "$BASE_URL/api/activitypub/inbox" "OrderedCollection" "application/activity+json"
test_endpoint "Followers" "$BASE_URL/api/activitypub/followers" "OrderedCollection" "application/activity+json"
test_endpoint "Following" "$BASE_URL/api/activitypub/following" "OrderedCollection" "application/activity+json"
echo ""
