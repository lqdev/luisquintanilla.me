...
![Create Azure Storage Account](/files/images/deploy-machine-learning-mlnet-model-blazor-webassembly1.png)

Then, navigate to your newly created storage account resource and create a blob container called `models`.

![Create Blob Container](/files/images/deploy-machine-learning-mlnet-model-blazor-webassembly2.png)

Once your container is created, navigate to it and upload the *model.zip* file.

![Upload Model](/files/images/deploy-machine-learning-mlnet-model-blazor-webassembly3.png)
...
![Enable Static Website](/files/images/deploy-machine-learning-mlnet-model-blazor-webassembly4.png)
...
![Configure CORS](/files/images/deploy-machine-learning-mlnet-model-blazor-webassembly5.png)
...
![Copy files into web container](/files/images/deploy-machine-learning-mlnet-model-blazor-webassembly6.png)
...
![Test the application](/files/images/deploy-machine-learning-mlnet-model-blazor-webassembly7.png)
