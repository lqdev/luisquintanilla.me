...
![Create Azure Storage Account](/api/files/images/deploy-machine-learning-mlnet-model-blazor-webassembly1.png)

Then, navigate to your newly created storage account resource and create a blob container called `models`.

![Create Blob Container](/api/files/images/deploy-machine-learning-mlnet-model-blazor-webassembly2.png)

Once your container is created, navigate to it and upload the *model.zip* file.

![Upload Model](/api/files/images/deploy-machine-learning-mlnet-model-blazor-webassembly3.png)
...
![Enable Static Website](/api/files/images/deploy-machine-learning-mlnet-model-blazor-webassembly4.png)
...
![Configure CORS](/api/files/images/deploy-machine-learning-mlnet-model-blazor-webassembly5.png)
...
![Copy files into web container](/api/files/images/deploy-machine-learning-mlnet-model-blazor-webassembly6.png)
...
![Test the application](/api/files/images/deploy-machine-learning-mlnet-model-blazor-webassembly7.png)
