...
![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-1.png)
...
![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-2.png)
...
![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-3.png)

Once logged in, click `Create Project`.

![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-4.png)

Enter the name of your project as well as a short description. Then, click `Create`.

![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-5.png)
...
![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-6.png)
...
![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-7.png)

In the `Builds` pipeline page, click `New pipeline`.

![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-8.png)

Select GitHub as the source and connect your GitHub account with Azure DevOps.

![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-9.png)
...
![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-10.png)
...
![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-11.png)
...
![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-12.png)
...
![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-13.png)
...
![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-19.png)
...
![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-20.png)

The `Working Directory` will be set to `ModelTrainer` like in the previous task.

![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-21.png)
...
![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-22.png)
...
![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-23.png)
...
![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-24.png)
...
![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-25.png)
...
![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-29.png)
...
![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-30.png)
...
![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-31.png)
...
![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-32.png)
...
![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-38.png)
...
![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-39.png)

Once in that page, click on `New pipeline`.

![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-40.png)

As with our CI pipeline, we'll start off with an `Empty Job` which we'll configure at a later time.

![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-41.png)
...
![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-42.png)
...
![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-43.png)
...
![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-44.png)

When finished, close out the form and click on the hyperlink below the stage title. 

![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-45.png)
...
![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-46.png)
...
![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-47.png)
...
![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-48.png)

Once an Azure subscription has been linked, let's change the `Script Location` setting to `Inline Script`.

![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-49.png)
...
![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-50.png)

Like in the previous task, our script will be inline. 

![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-51.png)
...
![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-52.png)

![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-53.png)
...
![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-54.png)
...
![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-55.png)

This will take you to the CI pipeline page. While on this page, click `Edit`.

![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-56.png)

Then, click on `Triggers`.

![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-57.png)
...
![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-58.png)
...
![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-59.png)

Once on the CD pipeline's page, click `Edit`.

![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-60.png)
...
![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-61.png)
...
![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-62.png)

From the CI pipeline page click `Queue`.

![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-63.png)

This will prompt a modal to show up in which you can just click `Queue` to start the build.

![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-64.png)
...
![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-68.png)
...
![](/assets/images/azdevops-mlnet-aci/azdevops-mlnet-69.png)
