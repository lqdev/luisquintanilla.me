...
![](/images/ml-lifecycle-management-mlflow-automated-ml-net-1.png)
...
![](/images/ml-lifecycle-management-mlflow-automated-ml-net-2.png)

Inspecting the detailed view of the best run for that experiment would look like the image below:

![](/images/ml-lifecycle-management-mlflow-automated-ml-net-3.png)
