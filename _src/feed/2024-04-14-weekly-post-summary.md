...
- [LLM training in simple, raw C/CUDA ](/responses/llm-c-karpathy)
...
- [Proton and Standard Notes are joining forces ](/responses/proton-acquires-standard-notes)
- [DE-COP: Detecting Copyrighted Content in Language Models Training Data](/responses/decop-detecting-copyright-llm-training-data)
- [Using LLM to select the right SQL Query from candidates](/responses/llm-text-to-sql-right-candidates)
- [Griffin: Mixing Gated Linear Recurrences with Local Attention for Efficient Language Models](/responses/griffin-mix-linear-recurrence-local-attention-language-models)
