module RssService
    ...
    let generateBlogRss (posts:Post array) = 
        ...
        let channel = blogChannelXml (DateTime.Parse(latestPost.Metadata.Date))
    ...
    let generateMainFeedRss (posts:Post array) =
        ...
        let channel = feedChannelXml "Luis Quintanilla Feed" "Main Feed" (DateTime.Parse(latestPost.Metadata.Date))
