...
let reviewPostView = ContentViews.reviewPostView
...
let reviewsView = CollectionViews.reviewsView
let snippetsView = CollectionViews.snippetsView
let wikisView = CollectionViews.wikisView
let aiMemexView = CollectionViews.aiMemexView
...
let marketplaceIndexView = CollectionViews.marketplaceIndexView
...
let marketplaceListingView = LayoutViews.marketplaceListingView
let snippetPageView = LayoutViews.snippetPageView
let wikiPageView = LayoutViews.wikiPageView
let aiMemexPageView = LayoutViews.aiMemexPageView
