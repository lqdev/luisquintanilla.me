    ...
    let desertNavigation = 
        [
            ...
            nav [_class "desert-nav"; _id "sidebar-menu"; attr "role" "navigation"; attr "aria-label" "Main navigation"] [
                ...
                // Content Types (Medium-focused collections)
                div [_class "nav-section dropdown"] [
                    button [_class "nav-link dropdown-toggle"; attr "data-target" "content-types-dropdown"] [
                        tag "svg" [_class "nav-icon"; attr "viewBox" "0 0 16 16"; attr "fill" "currentColor"] [
                    ...
                    div [_class "dropdown-menu"; _id "content-types-dropdown"] [
                ...
                // Topic Guides (Topic-focused collections)
                div [_class "nav-section dropdown"] [
                    button [_class "nav-link dropdown-toggle"; attr "data-target" "topic-guides-dropdown"] [
                        tag "svg" [_class "nav-icon"; attr "viewBox" "0 0 16 16"; attr "fill" "currentColor"] [
                    ...
                    div [_class "dropdown-menu"; _id "topic-guides-dropdown"] [
                        ...
                        div [_class "dropdown-divider"] []
                        a [_class "dropdown-item"; _href "/collections"] [Text "All Collections"]
                    ]
                ]
